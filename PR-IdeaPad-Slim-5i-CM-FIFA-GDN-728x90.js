...
lib.ssMetadata = [
		{name:"PR_IdeaPad_Slim_5i_CM_FIFA_GDN_728x90_atlas_1", frames: [[0,522,50,50],[0,0,728,90],[402,254,295,84],[0,346,347,87],[286,438,254,85],[0,435,284,85],[349,346,281,90],[0,254,400,90],[0,92,720,90],[0,184,706,68]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["PR_IdeaPad_Slim_5i_CM_FIFA_GDN_728x90_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.PRIdeaPadSlim5iCMFIFAGDN728x90 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},299).wait(31));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(249).to({_off:false},0).to({_off:true},50).wait(31));

	// F5
	this.instance_3 = new lib.F5();
	this.instance_3.setTransform(292,0);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(200).to({_off:false},0).to({_off:true},49).wait(81));

	// F4
	this.instance_4 = new lib.F4();
	this.instance_4.setTransform(301,0);
	...
	this.instance_5.setTransform(323,5);
	...
	this.instance_6.setTransform(243,3);
	...
	this.instance_7.setTransform(309,3);
...
// library properties:
lib.properties = {
	id: '4C0CA4231AA9AA43A4289A51FD0E9FF4',
	width: 728,
	height: 90,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/PR_IdeaPad_Slim_5i_CM_FIFA_GDN_728x90_atlas_1.png", id:"PR_IdeaPad_Slim_5i_CM_FIFA_GDN_728x90_atlas_1"}
	],
	preloads: []
};
...
an.compositions['4C0CA4231AA9AA43A4289A51FD0E9FF4'] = {
